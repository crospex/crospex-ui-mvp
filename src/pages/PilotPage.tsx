    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 selection:bg-primary/30 selection:text-primary-light font-sans">
      <nav className="relative z-10 px-6 py-8 max-w-7xl mx-auto flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center cursor-pointer">
          <div className="flex items-center">
            ...
            <span className="text-xl font-bold tracking-tight text-white mb-1">crospec</span>
          </div>
        </Link>
      </nav>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-10 lg:py-10 grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-4xl lg:text-6xl font-bold text-white tracking-tight leading-[1.1] mb-6">
              Accelerate Your <span className="text-primary-dark bg-clip-text bg-linear-to-r from-primary to-indigo-400">Inspection Intelligence</span>
            </h1>
        ...
        <div className="relative group">
          <div className="absolute -inset-1 bg-linear-to-r from-primary/20 to-indigo-500/20 rounded-3xl blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
